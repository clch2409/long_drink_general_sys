...
public class ExportarExcel {
    ...
    private void escribirInscripcion(){
        ...
        for(Inscripcion i: listaInscripciones){
            ...
            crearCelda(fila,columnaActual++,i.getSeccion().getFechaInicio(),estiloFecha);
            crearCelda(fila,columnaActual++,i.getSeccion().getFechaFinal() == null ? "N/A" : i.getSeccion().getFechaFinal(),i.getSeccion().getFechaFinal() == null ? estilo : estiloFecha);
